...
//
val mapFoldResults = (1..15).filter{ it % 3 == 0 || it % 5 == 0}.map { 
    when {
...
//  Bonus Points
/*
    1. Seneca the Younger was a Roman Stoic philosopher, statesman, dramatist, and satirist in the work Silver Age of Latin literature.
    2. He is commonly associated with the Stoicism
    3. Stoicism aserts that virtue is happiness and judgment should be based on behavior , rather than words.
*/
